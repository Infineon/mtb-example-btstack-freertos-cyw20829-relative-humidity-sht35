 ...
 * File Name: main.c
 *
 * Description: This file contains the starting point of Bluetooth LE SHT35
 *              relative humidity & temperature sensing service application.
 *
...
/* This function initializes the required BLE ESS & SHT35 task */
                           ...
                           wiced_bt_management_evt_data_t *p_event_data)
{
    ...
    {
        printf("\nThis application implements a custom SHT35 Sensing\n" \
                "Service and sends SHT35 sensor data over BLE\n");
