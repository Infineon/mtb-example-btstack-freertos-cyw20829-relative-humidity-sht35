...
APPNAME=mtb-example-btstack-freertos-cyw20829-relative-humidity-sht35
...
CY_IGNORE+=$(SEARCH_sht3x)/example-usage \
           $(SEARCH_sht3x)/example-usage-single-shot \
           $(SEARCH_sht3x)/sample-implementations \
		   $(SEARCH_sht3x)/tests \
           $(SEARCH_sht3x)/sensirion_i2c_hal.c
